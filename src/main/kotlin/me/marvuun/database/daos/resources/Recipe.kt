...
fun getAvailableRecipes(resource: Recipe<*>? = null, stationType: StationTypes? = null, home: Home) =
  if (resource != null) when (resource) {
  ...
  else if (stationType != null) when (stationType) {
  ...
  else throw Exception("Can't get available recipes since the resource and the station type are null.")
